...
# Trait name
# List of possiblities to run M1, M2, or M3:
    # M1: traitname = 'FPC1_Combined'
    # M2: traitname = 'FPC1_RCC'
    # M3: traitname = 'FPC1_TNDGR'
...
for i in range(num_reps):
    ...
    bestmodel.add(Dense(best_dense_neurons, activation='relu'))
